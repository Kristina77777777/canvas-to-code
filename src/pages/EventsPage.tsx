            ...
            <table className="w-full font-body text-sm">
              <thead>
                <tr className="border-b border-border">
                  ...
                  <th className="text-left py-3 px-2 font-medium text-muted-foreground">Время</th>
                  <th className="text-left py-3 px-2 font-medium text-muted-foreground">Мероприятие</th>
                  <th className="text-left py-3 px-2 font-medium text-muted-foreground">Формат</th>
                  <th className="text-left py-3 px-2 font-medium text-muted-foreground">Для кого</th>
                  <th className="text-left py-3 px-2 font-medium text-muted-foreground">Запись</th>
                </tr>
              </thead>
              <tbody>
